...
World.prototype.init = function() {
	...
	this.camera.position = new THREE.Vector3(100, 20, -200);
	...
	this.flock = new Flock(this.scene, this.octree, this.obstacles, 40);

	this.last_time = new Date();

	this.elapsed_time = 0;

        this.ground = new THREE.Mesh(new THREE.SphereGeometry(50,50,50), new THREE.MeshLambertMaterial({color: 0x0000DD, wireframe: true}));
	...
	this.min_velocity_control = this.bc.add(this, "min_velocity", 0, 70);
	this.max_velocity_control = this.bc.add(this, "max_velocity", 8, 150);
